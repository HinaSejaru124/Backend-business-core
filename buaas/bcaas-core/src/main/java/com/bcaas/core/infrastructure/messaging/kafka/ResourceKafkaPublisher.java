...
import com.bcaas.core.resource.port.output.ResourceEventPublisher;
...
@Component
public class ResourceKafkaPublisher implements ResourceEventPublisher {

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final KafkaEventSerializer serializer;
    private final String topic;

    public ResourceKafkaPublisher(
            KafkaTemplate<String, String> kafkaTemplate,
            KafkaEventSerializer serializer,
            @Value("${bcaas.kafka.topics.resource-events:bcaas.resource.events}") String topic) {
    ...
    @Override
    public Mono<Void> publish(ResourceDomainEvent event) {
